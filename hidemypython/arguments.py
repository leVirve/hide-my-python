...
def create_argument_parser():
    ...
    arg_parser.add_argument(
            '-n', dest='number_of_proxies', type=int,
            default=0,
    ...
    arg_parser.add_argument(
            '-a', default=0, action='count', dest='anonymity',
    ...
    arg_parser.add_argument(
            '-s', default=1, action='count', dest='speed',
